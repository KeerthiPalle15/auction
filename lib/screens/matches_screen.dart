...
class MatchesScreen extends ConsumerWidget {
          ...
          return matchesAsync.when(
            data: (matches) {
              ...
              final sortedMatches = matches
                ..sort(
                  (a, b) => (b.scheduledAt ?? DateTime.now()).compareTo(
                      ...
                      children: [
                        ListTile(
                          ...
                          subtitle: Column(
                            ...
                            children: [
                              Text(
                                'Status: ${match.status.toUpperCase()} | ${match.venue ?? "TBD"}',
                              ),
                              ...
                              children: [
                                TextButton.icon(
                                  onPressed: () => Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (ctx) =>
                                          MatchControlScreen(matchId: match.id),
                                    ),
                                  ),
                                ...
                                ElevatedButton.icon(
                                  onPressed: () =>
                                      context.push('/live_score/${match.id}'),
  ...
  Future<Map<String, dynamic>> _getMatchResult(
    WidgetRef ref,
    String matchId,
  ) async {
