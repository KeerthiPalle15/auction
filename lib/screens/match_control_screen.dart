...
class _MatchControlScreenState extends ConsumerState<MatchControlScreen> {
                ...
                builder: (context, teamSnapshot) {
                  ...
                  return ListView(
                    ...
                    children: [
                      ...
                      if (match.status == 'live') _buildInningsSection(match),
                      const SizedBox(height: 32),
  ...
  Widget _buildStatusHeader(MatchModel match, TeamModel t1, TeamModel t2) {
    String tossWinnerName = match.tossWinnerId == t1.id
        ? t1.name
        : (match.tossWinnerId == t2.id ? t2.name : 'Unknown');
    return Card(
        ...
        child: Column(
          children: [
            ...
            if (match.tossWinnerId != null)
              Text(
                'Toss: Won by $tossWinnerName - Elected to ${match.tossDecision?.toUpperCase()}',
                style: const TextStyle(color: Colors.white70),
              ),
            if (match.innings != null)
              Text(
                'Innings ${match.innings} In Progress',
                style: const TextStyle(
